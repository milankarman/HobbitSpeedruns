    ...
    <Layout title="Home | HobbitSpeedruns" headerText="hobbitspeedruns">
      <Row>
        <Col className="mb-3">
          ...
          <p>
            On here you will find guides for the speedrunning routes of the different platforms the game is on as well
            as links to community resources. This website was made with the hope of providing an accessible and central
            place one can come to find anything they might want to know when they are interesting in The Hobbit
            speedrunning. Though this site does feature a leaderboard, for more complete leaderboards one should go to{' '}
            <a href="https://www.speedrun.com/hobbit"> speedrun.com. </a>
          </p>
          <p>
          ...
          <p>Below is a long form documentary showcasing the game`&apos`s rich speedrunning history.</p>
